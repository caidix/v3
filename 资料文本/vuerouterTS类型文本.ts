...
// RouterHistory Router HistoryState HistoryLocation RouteRecordRaw RouterLink 等~~~
...
declare interface MatcherLocation
  extends Pick<RouteLocation, 'name' | 'path' | 'params' | 'matched' | 'meta'> {}
...
declare type RouteRecordRedirectOption =
  | RouteLocationRaw
